...
enum Variable_Type {
  Variable_Type_Int = 0,
  Variable_Type_Ptr = 1,
  Variable_Type_Char = 2
};
bool Variable_Type_IsValid(int value);
const Variable_Type Variable_Type_Type_MIN = Variable_Type_Int;
const Variable_Type Variable_Type_Type_MAX = Variable_Type_Char;
const int Variable_Type_Type_ARRAYSIZE = Variable_Type_Type_MAX + 1;

const ::google::protobuf::EnumDescriptor* Variable_Type_descriptor();
inline const ::std::string& Variable_Type_Name(Variable_Type value) {
  return ::google::protobuf::internal::NameOfEnum(
    Variable_Type_descriptor(), value);
}
inline bool Variable_Type_Parse(
    const ::std::string& name, Variable_Type* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Variable_Type>(
    Variable_Type_descriptor(), name, value);
}
enum Variable_OtherType {
  Variable_OtherType_Array = 0,
  Variable_OtherType_Struc = 1
};
bool Variable_OtherType_IsValid(int value);
const Variable_OtherType Variable_OtherType_OtherType_MIN = Variable_OtherType_Array;
const Variable_OtherType Variable_OtherType_OtherType_MAX = Variable_OtherType_Struc;
const int Variable_OtherType_OtherType_ARRAYSIZE = Variable_OtherType_OtherType_MAX + 1;

const ::google::protobuf::EnumDescriptor* Variable_OtherType_descriptor();
inline const ::std::string& Variable_OtherType_Name(Variable_OtherType value) {
  return ::google::protobuf::internal::NameOfEnum(
    Variable_OtherType_descriptor(), value);
}
inline bool Variable_OtherType_Parse(
    const ::std::string& name, Variable_OtherType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Variable_OtherType>(
    Variable_OtherType_descriptor(), name, value);
}
...
class Variable : public ::google::protobuf::Message {
 public:
  ...
  typedef Variable_Type Type;
  static const Type Int = Variable_Type_Int;
  static const Type Ptr = Variable_Type_Ptr;
  static const Type Char = Variable_Type_Char;
  static inline bool Type_IsValid(int value) {
    return Variable_Type_IsValid(value);
  }
  static const Type Type_MIN =
    Variable_Type_Type_MIN;
  static const Type Type_MAX =
    Variable_Type_Type_MAX;
  static const int Type_ARRAYSIZE =
    Variable_Type_Type_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  Type_descriptor() {
    return Variable_Type_descriptor();
  }
  static inline const ::std::string& Type_Name(Type value) {
    return Variable_Type_Name(value);
  }
  static inline bool Type_Parse(const ::std::string& name,
      Type* value) {
    return Variable_Type_Parse(name, value);
  }

  typedef Variable_OtherType OtherType;
  static const OtherType Array = Variable_OtherType_Array;
  static const OtherType Struc = Variable_OtherType_Struc;
  static inline bool OtherType_IsValid(int value) {
    return Variable_OtherType_IsValid(value);
  }
  static const OtherType OtherType_MIN =
    Variable_OtherType_OtherType_MIN;
  static const OtherType OtherType_MAX =
    Variable_OtherType_OtherType_MAX;
  static const int OtherType_ARRAYSIZE =
    Variable_OtherType_OtherType_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  OtherType_descriptor() {
    return Variable_OtherType_descriptor();
  }
  static inline const ::std::string& OtherType_Name(OtherType value) {
    return Variable_OtherType_Name(value);
  }
  static inline bool OtherType_Parse(const ::std::string& name,
      OtherType* value) {
    return Variable_OtherType_Parse(name, value);
  }
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Variable_Type>() {
  return ::Variable_Type_descriptor();
}
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Variable_OtherType>() {
  return ::Variable_OtherType_descriptor();
}
template <>
